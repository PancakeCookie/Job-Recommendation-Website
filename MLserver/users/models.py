...
class User(models.Model):
    ...
    rec_cate1 = models.CharField(null=True, max_length=30)
    rec_cate2 = models.CharField(null=True, max_length=30)
    rec_cate3 = models.CharField(null=True, max_length=30)
